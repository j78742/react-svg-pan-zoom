 ...
 * @returns {Object}
 */
function common_getDefaultValue(viewerWidth, viewerHeight, SVGViewBoxX, SVGViewBoxY, SVGWidth, SVGHeight, scaleFactorMin, scaleFactorMax) {
 ...
 * @returns {Object}
 */
function common_setSVGViewBox(value, SVGViewBoxX, SVGViewBoxY, SVGWidth, SVGHeight) {
  return common_set(value, { SVGViewBoxX: SVGViewBoxX, SVGViewBoxY: SVGViewBoxY, SVGWidth: SVGWidth, SVGHeight: SVGHeight });
}
...
function pan_pan(value, SVGDeltaX, SVGDeltaY) {
  ...
  // apply pan limits
  if (panLimit) {
    var _applyToPoints = Object(transformation_matrix_min["applyToPoints"])(matrix, [{ x: value.SVGViewBoxX + panLimit, y: value.SVGViewBoxY + panLimit }, { x: value.SVGViewBoxX + value.SVGWidth - panLimit, y: value.SVGViewBoxY + value.SVGHeight - panLimit }]),
...
function zoom_fitToViewer(value) {
  return zoom_fitSelection(value, value.SVGViewBoxX, value.SVGViewBoxY, value.SVGWidth, value.SVGHeight);
}
  ...
  return external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
    ...
    external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
      ...
      external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
        'mask',
        { id: maskID },
        external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement('rect', { x: SVGViewBoxX, y: SVGViewBoxY, width: SVGWidth, height: SVGHeight, fill: '#ffffff' }),
...
miniature_mask_MiniatureMask.propTypes = {
  SVGViewBoxX: external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.number.isRequired,
  SVGViewBoxY: external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.number.isRequired,
...
var viewer_ReactSVGPanZoom = function (_React$Component) {
  ...
  function ReactSVGPanZoom(props, context) {
    ...
    if (SVGViewBox) {
      ...
      var _SVGViewBox$split$map2 = viewer_slicedToArray(_SVGViewBox$split$map, 4);
    ...
    _this.state = {
      value: value ? value : common_getDefaultValue(viewerWidth, viewerHeight, SVGViewBoxX, SVGViewBoxY, SVGWidth, SVGHeight, scaleFactorMin, scaleFactorMax),
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (SVGViewBox) {
        var _SVGViewBox$split$map3 = SVGViewBox.split(' ').map(parseFloat),
            _SVGViewBox$split$map4 = viewer_slicedToArray(_SVGViewBox$split$map3, 4),
        ...
        if (value.SVGViewBoxX !== x0 || value.SVGViewBoxY !== y0 || value.SVGWidth !== width || value.SVGHeight !== height) {
          nextValue = common_setSVGViewBox(nextValue, x0, y0, width, height);
          needUpdate = true;
        }
      } else {
        if (value.SVGViewBoxX !== 0 || value.SVGViewBoxY !== 0 || value.SVGWidth !== SVGWidth || value.SVGHeight !== SVGHeight) {
          nextValue = common_setSVGViewBox(nextValue, 0, 0, SVGWidth, SVGHeight);
          needUpdate = true;
        }
      }
