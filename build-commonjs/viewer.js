...
var ReactSVGPanZoom = function (_React$Component) {
  ...
  function ReactSVGPanZoom(props, context) {
    ...
    _this.state = {
      value: value ? value : (0, _common.getDefaultValue)(viewerWidth, viewerHeight, SVGViewBoxX, SVGViewBoxY, SVGWidth, SVGHeight, scaleFactorMin, scaleFactorMax),
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (SVGViewBox) {
        ...
        if (value.SVGViewBoxX !== x0 || value.SVGViewBoxY !== y0 || value.SVGWidth !== width || value.SVGHeight !== height) {
          nextValue = (0, _common.setSVGViewBox)(nextValue, x0, y0, width, height);
          needUpdate = true;
        }
      } else {
...
ReactSVGPanZoom.propTypes = {
  ...
  value: _propTypes2.default.shape({
    ...
    SVGViewBoxX: _propTypes2.default.number.isRequired,
    SVGViewBoxY: _propTypes2.default.number.isRequired,
